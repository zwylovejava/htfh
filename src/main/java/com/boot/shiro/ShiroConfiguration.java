...
public class ShiroConfiguration {
	 @Bean(name="shiroFilter")
	    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager) {
	        ...
	        filterChainDefinitionMap.put("/product/findAll", "anon"); 	        	       
	        filterChainDefinitionMap.put("/product/findProdInfo", "anon");	        
	        filterChainDefinitionMap.put("/cart/cartadd", "anon");	        
	        filterChainDefinitionMap.put("/cart/cartdelete", "anon");
