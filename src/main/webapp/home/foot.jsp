...
<div class="fixedBox">
  <ul class="fixedBoxList">
	...
	<tr>
		<td>
			<a href="${ctx}/message/selled.action" onclick="openDiv(this)">热销商品</a>
		</td>
	</tr>
	<tr>
		<td>
			<a href="${ctx}/message/selling.action" onclick="openDiv(this)">疯狂抢购</a>
		</td>
	</tr>
	<tr>
		<td>
			<a href="${ctx}/message/discount.action" onclick="openDiv(this)">降价促销</a>
		</td>
	</tr>
    </table>
     </strong>
