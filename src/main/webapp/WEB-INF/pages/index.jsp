   	...
   	<div id="slideBox" class="slideBox">
			...
			<div class="bd">
				<ul>
					...
					<li><a href="javascript:void(0)" target="_parent"><div style="background:url(AD/ad-3.jpg) no-repeat;background-position:center; width:100%; height:750px;"></div></a></li>
                    <li><a href="javascript:void(0)" target="_parent"><div style="background:url(AD/ad-7.jpg) no-repeat;background-position:center; width:100%; height:510px;"></div></a></li>
                    <li><a href="javascript:void(0)" target="_parent"><div style="background:url(AD/ad-6.jpg) no-repeat;background-position:center; width:100%; height:600px;"></div></a></li>
