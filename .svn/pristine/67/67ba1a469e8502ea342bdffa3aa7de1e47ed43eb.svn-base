...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">商品添加</h2>
       <a href="${ctx}/back/findAll" class="fr top_rt_btn">返回产品列表</a>
      </div>
     ...
     <section>
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" class="textbox" placeholder="商品价格..."  id ="price" name="price" value="${product.price}"/>
       ...
       <li>
        ...
        <c:forEach items="${ListCla}" var="listCla">
         <option value="${listCla.classificId}" selected="selected">${listCla.classificName}</option>
        </c:forEach>
        </select>
       ...
       <li>
         ...
         <input type="text" class="textbox textbox_295" placeholder="库存数量..." id ="pnum" name="pnum" value="${product.pnum}"/>
	...
	<li>
       ...
       <li>
        ...
        <label class="uploadImg">
         <input type="file" id="file" name="uploadFile" onchange="handleFile()"/>
         <span>上传图片</span>
       ...
       <li>
        ...
        <input hwidth="100px" type="button" class="link_btn" onclick="SubmitForm(this)" value="提交" />
       </li>
      </ul>
     </section>
     </form>
